...
class ParkingNotificationPopup extends StatefulWidget {
  final List<Content> contentList;
  const ParkingNotificationPopup({super.key, required this.contentList});

  @override
  State<ParkingNotificationPopup> createState() => _ParkingNotificationPopupState();
}

class _ParkingNotificationPopupState extends State<ParkingNotificationPopup> {
